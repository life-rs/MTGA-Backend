...
class Profile extends BaseModel {
    ...
    */
    ...
    async addDialogue(id, messageContent, rewards = [], socketId) {
        let dialogue;
        ...
        await notificationHandler.sendNotification(socketId, await notificationHandler.createNewNotification(message))
    }
